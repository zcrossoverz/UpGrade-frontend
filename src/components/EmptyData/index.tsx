...
function EmptyData() {
  ...
  return (
    <div className='justify-center h-10 w-90'>
      <center className='m-auto'>
        ...
        <div className='tracking-widest mt-4'>
          <span className='text-gray-500 text-3xl block'>
      ...
      <center className='mt-6'>
        <button
          className='text-gray-500 font-mono text-xl bg-gray-200 p-3 rounded-md hover:bg-green-400 hover:text-white'
          onClick={() => navigate("/")}
        >
          Có, đi nào{" "}
        </button>
